...
class ForeLegM(object):
	...
	def angel_2_pos(self, q1, q2):
		PI = math.pi
		hip_angle = q1+ PI
		Ey = self.len[0]*math.sin(hip_angle)
		Ez = 0 - self.len[0]*math.cos(hip_angle)
		...
		a_EFy = math.acos((Ez-Fz)/self.len[5])
		...
		print("<EFy = :", 180*a_EFy/math.pi, " -- alpha = ", 180*self.len[7]/math.pi)
